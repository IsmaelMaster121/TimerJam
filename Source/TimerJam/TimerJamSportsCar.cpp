...
#include "TimerJamSportsCar.h"
#include "TimerJamSportsWheelFront.h"
#include "TimerJamSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ATimerJamSportsCar::ATimerJamSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTimerJamSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTimerJamSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTimerJamSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTimerJamSportsWheelRear::StaticClass();
