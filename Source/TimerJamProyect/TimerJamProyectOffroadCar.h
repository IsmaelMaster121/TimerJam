...
#include "TimerJamProyectOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class TIMERJAMPROYECT_API ATimerJamProyectOffroadCar : public ATimerJamProyectPawn
{
	GENERATED_BODY()
