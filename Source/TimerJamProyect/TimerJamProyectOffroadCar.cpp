...
#include "TimerJamProyectOffroadCar.h"
#include "TimerJamProyectOffroadWheelFront.h"
#include "TimerJamProyectOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ATimerJamProyectOffroadCar::ATimerJamProyectOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTimerJamProyectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTimerJamProyectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTimerJamProyectOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTimerJamProyectOffroadWheelRear::StaticClass();
