...
#include "TimerJamProyectSportsCar.h"
#include "TimerJamProyectSportsWheelFront.h"
#include "TimerJamProyectSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ATimerJamProyectSportsCar::ATimerJamProyectSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTimerJamProyectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTimerJamProyectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTimerJamProyectSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTimerJamProyectSportsWheelRear::StaticClass();
